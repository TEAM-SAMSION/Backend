...
import com.pawith.userdomain.service.UserDeleteValidateService;
...
public class UserDeleteUseCase {
    ...
    private final UserDeleteValidateService userDeleteValidateService;
    private final ApplicationEventPublisher applicationEventPublisher;

    public void deleteUser(){
        final User user = userUtils.getAccessUser();
        userDeleteValidateService.validateDeleteUser(user);
